      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Navigate to any part of the resume builder from this central dashboard. 
            Create, manage, and share professional resumes with ease.
          </p>
        </div>
        ...
        <footer className="mt-16 pt-8 box-shadow">
          <div className="text-center text-gray-600">
            <p className="mb-2">
              RapidApply Resume Builder - Professional Resume Management
            </p>
